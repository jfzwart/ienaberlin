...
import { DeploymentOptions, RuntimeOptions, SUPPORTED_REGIONS } from 'firebase-functions/lib/function-configuration';
...
export declare class FunctionBuilder {
    ...
    get https(): {
         ...
         */
        onRequest: (handler: (req: https.Request, resp: express.Response) => void | Promise<void>) => import("firebase-functions/lib/cloud-functions").HttpsFunction;
        /**
         * Declares a callable method for clients to call using a Firebase SDK.
         * @param handler A method that takes a data and context and returns a value.
         */
        onCall: (handler: (data: any, context: https.CallableContext) => any | Promise<any>) => import("firebase-functions/lib/cloud-functions").TriggerAnnotated & ((req: express.Request<import("express-serve-static-core").ParamsDictionary>, resp: express.Response<any>) => void | Promise<void>) & import("firebase-functions/lib/cloud-functions").Runnable<any>;
    };
    get database(): {
        /**

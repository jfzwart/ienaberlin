...
import { Change, CloudFunction, Event, EventContext } from 'firebase-functions/lib/cloud-functions';
import { DeploymentOptions } from 'firebase-functions/lib/function-configuration';
/** @hidden */
